    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-black via-purple-900 to-black">
      ...
      >
        <div className="flex items-center justify-center mb-8">
          <img src="/images/logos/jisce.png" alt="JISCE Logo" className="w-24 h-24 object-contain" />
          <h2 className="text-2xl md:text-3xl text-white ml-4">25 Glorious Years of Excellence at JISCE</h2>
        </div>
