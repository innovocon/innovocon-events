...
export function HackNex() {
  const stats = [
    { icon: Calendar, title: 'Date', desc: 'February 27-28, 2025' },
    { icon: Users, title: 'Team Size', desc: '2-4 Members' },
    { icon: Trophy, title: 'Prize Pool', desc: '₹12,000 + Prizes' },
  ...
  const prizes = [
    ...
    },
    {
      ...
      items: [
        '350 .xyz domains for participants',
        'LinkedIn Premium (6 months) for top 10 teams',
        'Certificates for all participants',
        'Trophies for top 3 teams',
        'Exclusive swags and goodies'
      ]
    }
  ];
  ...
  return (
    <div className="pt-16">
      ...
      <AnimatedSection className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-white text-center mb-16">Prizes</h2>
