...
export function Zenith() {
  const stats = [
    { icon: Calendar, title: 'Date', desc: 'February 28, 2025' },
    { icon: Users, title: 'Team Size', desc: 'BGMI: 4 Players / Valorant: 5 Players' },
    { icon: Trophy, title: 'Prize Pool', desc: '₹11,000' },
  ];
  ...
  const games = [
    ...
    },
    {
      ...
      schedule: 'Tournament: Feb 28, 2025'
    }
  ];
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="text-sm text-gray-300">
                    <span className="text-pink-400">Format:</span> {game.format}
                  </div>
                  {game.prizePool && (
                    <div className="text-sm text-gray-300">
                      <span className="text-pink-400">Prize Pool:</span> {game.prizePool}
                    </div>
                  )}
                  {game.prizes && (
                    <div className="text-sm text-gray-300">
                      <span className="text-pink-400">Prizes:</span>
